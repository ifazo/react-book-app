...
import { IStatus } from "../provider/types/Types";
...
export default function ReadingTable() {
    ...
    const handleAddToFinished = (id) => {
        ...
        try {
            ...
            toast.error('Failed to add to finished list');
        }
    };
                                ...
                                <tbody className="divide-y divide-gray-200 bg-white">
                                    {statuses?.map((status: IStatus) => (
                                        <tr key={status?._id}>
                                            ...
                                            <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{status?.email}</td>
                                            ...
                                            <td className="relative whitespace-nowrap py-4 pl-3 pr-4 text-center sm:pr-6 lg:pr-8">
                                                <Link to="/delete" className="text-red-600 hover:text-red-900">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">

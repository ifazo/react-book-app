                        ...
                        {data?.map((book: IBook) => (
                            <div key={book._id} className="group relative">
                                ...
                                <div className="flex justify-between">
                                    ...
                                    <p className="mt-1 text-sm font-medium text-gray-700">ISBN-{book.isbn}</p>
                                </div>
                                <div className="flex justify-between">
                                    <p className="mt-1 text-center text-sm font-medium text-gray-700">{book.categories[0]}</p>
                                    <p className="mt-1 text-center text-sm font-medium text-gray-700">Page-{book.pageCount}</p>
                                </div>
                            </div>
                        ))}
                    </div>
